...
async function populateLanguages() {
  ...
  try {
    for (let lang of languages) {
      await client.query(
        `INSERT INTO languages_id_name_mapping (language_id, language_name, boilerplate_generator_script)
         VALUES ($1, $2, $3)
         ON CONFLICT (language_id) DO NOTHING;`,
        [lang.id, lang.name, null]
      );
    }
    console.log("All languages inserted successfully!");
  } catch (err) {
